...
//			XStreamTest.test();
			...
			//第一种方法，调用业务层
			DownloadBillReqData downloadBillReqData = new DownloadBillReqData("", "20160608", "ALL");
			WXPay.doDownloadBillBusiness(downloadBillReqData, new DownloadBillBusiness.ResultListener() {
